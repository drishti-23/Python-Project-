...
def perform_login_validaion(func):
    @wraps(func)
    def wrapper(*args, **kwargs):
        try:
            ...
            return jsonify({'message': 'Invalid Server Error', 'error': str(e), "status code": 500})
...
def password_validation(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            if len(password) < 3:
                return {'error': 'Password must be atleast of 3 characters', "status code": 400}
